  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_var(--tw-gradient-stops))] from-slate-50 via-zinc-100 to-blue-100 text-zinc-900 pb-24 px-6 md:px-12 font-sans selection:bg-zinc-900 selection:text-white" dir="rtl">
      ...
      <header className="max-w-[1700px] mx-auto pt-20 pb-16 space-y-10">
        <div className="space-y-2 animate-in fade-in slide-in-from-top-10 duration-1000">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-stretch animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
          ...
          <div className="w-full flex">
            <button 
              ...
              className="w-full h-full min-h-[160px] bg-zinc-900 hover:bg-zinc-800 text-white p-8 rounded-[3.5rem] font-black shadow-2xl shadow-zinc-900/20 transition-all active:scale-[0.98] flex flex-col items-center justify-center gap-3 group relative overflow-hidden"
            >
              ...
              <span className="text-5xl leading-none group-hover:rotate-180 transition-all duration-700">＋</span>
              <span className="text-xs uppercase tracking-[0.3em] font-black opacity-90">תיעוד אימון מהיר</span>
            </button>
          </div>
        </div>
      </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <aside className="lg:col-span-3 space-y-12 animate-in fade-in slide-in-from-left-10 duration-1000 delay-600">
            ...
            <div className="bg-white/50 backdrop-blur-3xl border border-white/80 rounded-[3.5rem] shadow-2xl overflow-hidden sticky top-32">
              ...
              <div className="p-8 max-h-[600px] overflow-y-auto scrollbar-hide select-none">
                <MessageFeed 
                  title="" 
      ...
      {isAddLogOpen && (
        <div className="fixed inset-0 z-[200] flex items-end md:items-center justify-center p-0 md:p-8 animate-in fade-in duration-400">
            ...
            <div className="p-12">
              <header className="flex justify-between items-center mb-12 px-6">
                <div className="space-y-2">
                  <h3 className="text-5xl font-black tracking-tighter text-zinc-900 uppercase">תיעוד אימון מהיר</h3>
